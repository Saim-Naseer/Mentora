...
class SpiderSpider(scrapy.Spider):
    ...
    start_urls = ["https://www.eduopinions.com/universities/universities-in-pakistan/university-of-the-punjab-pu/"]
    ...
    def parse(self, response):
        ...
        for a in response.css("a"):
            ...
            # yield CrawlerItem (optional) - include where we plan to save the HTML
            item = CrawlerItem()
            item["title"] = title
            item["link"] = url
